...
class CoDinoTransformer(CoDeformableDetrTransformer):
    ...
    def forward(self,
        ...
        # print('*************forward_cls_branches***********',cls_branches)
        feat_flatten = []
        mask_flatten = []
        lvl_pos_embed_flatten = []
        spatial_shapes = []
        ...
        # print('*****************inter_references_out*******************',inter_references_out)
    ...
    def forward_aux(self,
        ...
        # print('*************forward_aus_cls_branches***********',cls_branches)
        for lvl, (feat, mask, pos_embed) in enumerate(
                zip(mlvl_feats, mlvl_masks, mlvl_pos_embeds)):
            bs, c, h, w = feat.shape
            spatial_shape = (h, w)
        ...
        inter_references_out = inter_references
        # print('*****************inter_states*******************',inter_states)
        # print('*****************inter_states*******************',inter_states.size())
        # print('*****************aux_inter_references_out*******************',inter_references_out.size())
