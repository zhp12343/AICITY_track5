...
class CoStandardRoIHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def _bbox_forward(self, x, rois):
        ...
        # TODO
        cls_score,cls_score1,bbox_pred = self.bbox_head(bbox_feats)
        # cls_score,bbox_pred = self.bbox_head(bbox_feats)
        # print("cls_score",cls_score.shape)
        # print("cls_score1",cls_score1.shape)

        bbox_results = dict(
            cls_score=cls_score,cls_score1=cls_score1, bbox_pred=bbox_pred, bbox_feats=bbox_feats)
    ...
    def _bbox_forward_train(self, x, sampling_results, gt_bboxes, gt_labels,
        ...
        # print('**********bbox_results***********',bbox_results['cls_score'].shape)
        # print('**********bbox_results1***********',bbox_results['cls_score1'])
        loss_bbox = self.bbox_head.loss(bbox_results['cls_score'],
                                        bbox_results['cls_score1'],
